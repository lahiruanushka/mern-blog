...
const Header = () => {
  ...
  // Create Post link will only be added if user is logged in
  const authenticatedNavItems = currentUser
    ? [
        ...navItems.slice(0, 1),
        { path: "/create-post", label: "Create Post", icon: FaBolt },
        ...navItems.slice(1),
      ]
    : navItems;
  ...
  "
      ...
      <ComingSoonModal
        ...
        featureName="View Notifications"
        message="We're working hard to bring you the ability to view notifications for your posts. This feature will be available soon!"
      />
    </>
  );
};
