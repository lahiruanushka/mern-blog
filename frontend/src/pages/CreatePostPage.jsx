...
const CreatePostPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!validateForm()) {
      setPublishError("Please fix the validation errors before publishing");
      return;
    }
    ...
    try {
      ...
      if (response.success) {
        ...
        setPublishError(response.message || "Failed to publish post");
      }
    } catch (error) {
      console.error(error);
                  ...
                  <div className="grid">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        aria-describedby={
                          validationErrors.excerpt ? "excerpt-error" : undefined
                        }
                      />
                      {validationErrors.excerpt && (
                        <p
